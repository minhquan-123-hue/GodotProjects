...
/** @type {string} */
const CACHE_VERSION = '1764839837|17023040356';
/** @type {string} */
const CACHE_PREFIX = '3D_games-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'first_tutorials_3d_game.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["first_tutorials_3d_game.html","first_tutorials_3d_game.js","first_tutorials_3d_game.offline.html","first_tutorials_3d_game.icon.png","first_tutorials_3d_game.apple-touch-icon.png","first_tutorials_3d_game.audio.worklet.js","first_tutorials_3d_game.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["first_tutorials_3d_game.wasm","first_tutorials_3d_game.pck"];
